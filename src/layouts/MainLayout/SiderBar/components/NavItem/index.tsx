...
function NavItem(props: any) {
    ...
    const handleCheckRouteActive = (routeActive: any, isShowMenu = false): Boolean => {
        let isActive = false;
        if (handleCheckRoute(routeActive) || isShowMenu) {
            isActive = true
        }
        return isActive;
    }
    ...
    return (
        <>
          ...
          `}>
            ...
            `}>
                                    {
                                        route.children.map((subMenu: any) => {
                                            return (
                      ...
                      ${handleCheckRoute(subMenu.routeActive) ? styles.menuSubFoSubItemActive : ''}`
                                                        }
                                                    >
                                                        <div className={styles.textWrap}>
                                                            <div className={styles.iconWrap}>
